...
// // # prints some helpful debugging things
// // if ! is encountered in a program, everything after it is considered as an input
//
...
//
//     Display display(fileString);
//
//     // main loop
//     for (curProgramIndex = 0; curProgramIndex < fileString.size(); curProgramIndex++) {
//         const char currentCharacter = fileString.at(curProgramIndex);
...
//                     int openLoops = 1;
//                     while (openLoops > 0) {
//                         if (curProgramIndex > fileString.size() || curProgramIndex < 0) {
//                             throw std::runtime_error(R"(A loop is missing a "[" or "]" somewhere)");
//                         }
//                         char curLoopChar = fileString.at(++curProgramIndex);
//
//                         if (curLoopChar == '[')
//                             openLoops++;
//                         else if (curLoopChar == ']')
